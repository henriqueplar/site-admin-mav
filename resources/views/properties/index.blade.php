@php
    $headers = ['Endereço', 'Status', 'Cliente'];
@endphp
...
<x-app-layout>
    ...
    <div class="bg-white dark:bg-gray-800 shadow flex w-full p-3 justify-between bg -z-10">
        <div></div>
        <div>
            <x-button data-modal-toggle="addPropertyModal">
                + Adicionar Imóvel
            </x-button>

            <div id="addPropertyModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-xl h-full md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <div class="flex justify-between items-center p-4 rounded-t border-b dark:border-gray-600">
                            <h2 class="dark:text-white text-black text-xl font-bold">Novo Imóvel</h2>
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                            data-modal-toggle="addPropertyModal">
    ...
    <x-table :headers="$headers">
        @if (count($properties) != 0)
            ...
            <tr>
                ...
                <td class="text-black">{{ $property->status }}</td>
                <td class="text-black">{{ $property->customer->name }}</td>
                <td class="text-black">
                    <a href="{{ route('properties.show', $property) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4 m-auto">
