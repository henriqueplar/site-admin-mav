...
<x-app-layout>
    ...
    <div class="flex w-full px-6 py-4 justify-between -z-10 items-center">
        ...
        {{-- NEW CUSTOMER BUTTON --}}
        <div>
            <x-button onclick="addPropertyModal.showModal()">+ Adicionar Imóvel</x-button>


            {{-- MODAL --}}
            <x-modal2 id="addPropertyModal" title="Adicionar Imóvel">
    ...
    {{-- DATA --}}
    <x-card type="table">
        @include('properties.table', $properties)
    </x-card>
</x-app-layout>
