    ...
    <div class="flex w-full px-6 py-4 justify-between -z-10 items-center">
        ...
        <nav aria-label="Breadcrumb">
            <ol class="flex items-center gap-1 text-sm text-black">
                ...
                <li>
                    <a href="{{ route('installments.index') }}" class="block transition hover:text-gray-700"> Recebíveis </a>
                </li>
            </ol>
        </nav>
        ...
        {{-- NEW CUSTOMER BUTTON --}}
        <div>
            <x-button onclick="addInstallmentModal.showModal()">+ Adicionar Recebível</x-button>
            
            {{-- MODAL --}}
            <x-modal2 title="Adicionar Recebível" id="addInstallmentModal">
