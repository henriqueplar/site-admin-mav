        ...
        @foreach ($installment->lines as $line)
            <tr>
                ...
                <td class="flex justify-end w-clip">
                    {{-- UPDATE --}}
                    <div>
                        <button onclick="updateLineModal{{ $line->id }}.showModal()"
                        ...
                        <dialog id="updateLineModal{{ $line->id }}" class="modal">
                            <div class="modal-box bg-white">
                                ...
                                @include('installment-lines.edit', $line)
                            </div>
                    ...
                    {{-- DELETE --}}
                    <form action="{{ route('installment-lines.destroy', $line) }}" method="POST"
